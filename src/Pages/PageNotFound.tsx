...
const PageNotFound = () => {
  ...
  return (
    <div className="bg-black diagonal-stripes min-h-screen flex flex-col items-center justify-center px-4 py-8">
      {/* 404 Numbers */}
      ...
      <button
        ...
        onClick={() => navigate("/")}
      >
        <div className="bg-[#00253d] hover:bg-[#000c13] rounded-xl h-12 w-1/4 flex items-center justify-center absolute left-1 top-1 group-hover:w-[97%] z-10 duration-500">
          <svg
